...
public class MileStone4Test {
    ...
    public void streamGetKey(){
        ...
        Set<String> set2 = new HashSet<>(Arrays.asList("nick", "address", "name"));
        Set<String> set3 = new HashSet<>(Arrays.asList("nick"));
        Set<String> set4 = new HashSet<>(Arrays.asList("zipcode", "street"));
        Set<String> set5 = new HashSet<>(Arrays.asList("zipcode"));
        Set<String> set6 = new HashSet<>(Arrays.asList("street"));
        Set<String> set7 = new HashSet<>(Arrays.asList("name"));
        expect.add(set1);
        expect.add(set2);
        expect.add(set3);
        expect.add(set4);
